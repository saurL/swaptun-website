  ...
  <UContainer>
    <UContainer>
      ...
      <ul>
        ...
        <li>
          Download and use our mobile application (Swaply), or any other
    ...
    <UContainer>
      ...
      <UAccordion :items="key_points_items"> </UAccordion>
    </UContainer>
<USeparator orientation="horizontal" class="h-10" />
    <!-- Table of Contents -->
...
<USeparator orientation="horizontal" class="h-10" />
    ...
    <UContainer>
      ...
      <p>
        ...
        information that we collect depends on the conp of your interactions
      ...
      <ul>
        <li>
          ...
          mobile device's contacts, and other features. If you wish to change
...
<USeparator orientation="horizontal" class="h-10" />
    ...
    <UContainer>
      ...
      <p
        >If you are located in Canada, this section applies to you.</p
      >
      <p>
...
<USeparator orientation="horizontal" class="h-10" />
    ...
    <UContainer>
      ...
      <p>
        ...
        portability; and (v) not to be subject to automated decisiomaking. In
      ...
      <ul>
        <li
          >Log in to your account settings and update your user account.</li
        >
      </ul>
      <p>
...
<USeparator orientation="horizontal" class="h-10" />
    ...
    <UContainer>
      ...
      <el-table :data="categories" style="width: 100%">
        ...
        <el-table-column prop="examples" label="Examples"></el-table-column>
        <el-table-column prop="collected" label="Collected"></el-table-column>
      </el-table>
      <p>
        We may also collect other personal information outside of these
        categories through instances where you interact with us in person,
        online, or by phone or mail in the conp of:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>Right to nodiscrimination for exercising your rights</li>
        <li>
      ...
      <p>
        ...
        subject access request, by emailing us at __________, or by referring to
      ...
      <p>
        ...
        us at __________. We will inform you in writing of any action taken or
        not taken in response to the appeal, including a written explanation of
        the reasons for the decisions. If your appeal is denied, you may submit
...
const key_points_items = ref([
  ...
  {
    label: "Do we process any sensitive personal information?",
    content:
  ...
  {
    label: "Do we collect any information from third parties?",
  ...
  {
    label: "How do you exercise your rights?",
    content:
...
ul {
  ...
  padding-left: 1.5rem; /* Add left padding for indentation */
}
